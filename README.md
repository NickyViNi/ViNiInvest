...
| POST /api/portfolios/     | This fetch is sent to create a new portfolio. Upon success, it returns an object representing that portfolio.     | {<br>&nbsp;<br>&nbsp;&nbsp;&nbsp;'id': INT, <br>&nbsp;&nbsp;&nbsp;'user_id': INT, <br>&nbsp;&nbsp;&nbsp;'created_at': STRING,<br>&nbsp;&nbsp;&nbsp;'fake_money_balance': INT, <br>&nbsp;&nbsp;&nbsp;'name': STRING, <br>&nbsp;&nbsp;&nbsp;'portfolio_stocks': Array, <br>&nbsp;&nbsp;&nbsp;'transactions': Array, <br>}<br><br>Status: 200<br>|
