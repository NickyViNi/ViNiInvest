...
| Request                        | Purpose                | Return Value  |
| :----------------------------- | :--------------------: | :------------------------------ |
| GET /api/portfolios/        | This fetch will return an object of portfolos array.                                 | {<br>&nbsp;Portfolios: [<br>&nbsp;&nbsp;&nbsp;'id': INT, <br>&nbsp;&nbsp;&nbsp;'user_id': INT, <br>&nbsp;&nbsp;&nbsp;'created_at': STRING,<br>&nbsp;&nbsp;&nbsp;'fake_money_balance': INT, <br>&nbsp;&nbsp;&nbsp;'name': STRING, <br>&nbsp;&nbsp;&nbsp;'portfolio_stocks': Array, <br>&nbsp;&nbsp;&nbsp;'transactions': Array, <br>]}<br><br>Status: 200<br>|
| GET /api/portfolios/:portfolioId     | This fetch will return an object of a specific portfolo array.                                 | {<br>&nbsp;<br>&nbsp;&nbsp;&nbsp;'id': INT, <br>&nbsp;&nbsp;&nbsp;'user_id': INT, <br>&nbsp;&nbsp;&nbsp;'created_at': STRING,<br>&nbsp;&nbsp;&nbsp;'fake_money_balance': INT, <br>&nbsp;&nbsp;&nbsp;'name': STRING, <br>&nbsp;&nbsp;&nbsp;'portfolio_stocks': Array, <br>&nbsp;&nbsp;&nbsp;'transactions': Array, <br>}<br><br>Status: 200<br>|
| POST /api/portfolios/     | This fetch is sent to create a new portfolio. Upon success, it returns an object representing that portfolio.     | {<br>&nbsp;<br>&nbsp;&nbsp;&nbsp;'id': INT, <br>&nbsp;&nbsp;&nbsp;'user_id': INT, <br>&nbsp;&nbsp;&nbsp;'created_at': STRING,<br>&nbsp;&nbsp;&nbsp;'fake_money_balance': INT, <br>&nbsp;&nbsp;&nbsp;'name': STRING, <br>&nbsp;&nbsp;&nbsp;'portfolio_stocks': Array, <br>&nbsp;&nbsp;&nbsp;'transactions': Array, <br>}<br><br>Status: 201<br>|
| PUT /api/portfolios/:portfolioId     | This fetch is sent to update a specific portfolio. Upon success, it returns an object representing that portfolio with a new name and new balance.     | {<br>&nbsp;<br>&nbsp;&nbsp;&nbsp;'id': INT, <br>&nbsp;&nbsp;&nbsp;'user_id': INT, <br>&nbsp;&nbsp;&nbsp;'created_at': STRING,<br>&nbsp;&nbsp;&nbsp;'fake_money_balance': INT, <br>&nbsp;&nbsp;&nbsp;'name': STRING, <br>&nbsp;&nbsp;&nbsp;'portfolio_stocks': Array, <br>&nbsp;&nbsp;&nbsp;'transactions': Array, <br>}<br><br>Status: 200<br>|
| DELETE /api/portfolios/:portfolioId     | This fetch is sent to delete(sell) all stocks in the specific portfolio. Upon success, it returns an object representing that portfolio.     | {<br>&nbsp;<br>&nbsp;&nbsp;&nbsp;'id': INT, <br>&nbsp;&nbsp;&nbsp;'user_id': INT, <br>&nbsp;&nbsp;&nbsp;'created_at': STRING,<br>&nbsp;&nbsp;&nbsp;'fake_money_balance': INT, <br>&nbsp;&nbsp;&nbsp;'name': STRING, <br>&nbsp;&nbsp;&nbsp;'portfolio_stocks': Array, <br>&nbsp;&nbsp;&nbsp;'transactions': Array, <br>}<br><br>Status: 200<br>|


### Stock
| Request                        | Purpose                | Return Value  |
| :----------------------------- | :--------------------: | :------------------------------ |
| GET /api/stocks/        | This fetch will return an array of all stocks.                       | {[<br>&nbsp;<br>&nbsp;&nbsp;&nbsp;'id': INT, <br>&nbsp;&nbsp;&nbsp;'name': STRING, <br>&nbsp;&nbsp;&nbsp;'symbol': STRING, <br>&nbsp;&nbsp;&nbsp;'created_at': STRING,<br>&nbsp;&nbsp;&nbsp;'category': STRING, <br>&nbsp;&nbsp;&nbsp;'newest_price': Object, <br>&nbsp;&nbsp;&nbsp;'prices': Array, <br>&nbsp;&nbsp;&nbsp;'stock_analyses': Array, <br>]}<br><br>Status: 200<br>|
| GET /api/stocks/:stockId        | This fetch will return an object of a specific stock.                       | {[<br>&nbsp;<br>&nbsp;&nbsp;&nbsp;'id': INT, <br>&nbsp;&nbsp;&nbsp;'name': STRING, <br>&nbsp;&nbsp;&nbsp;'symbol': STRING, <br>&nbsp;&nbsp;&nbsp;'created_at': STRING,<br>&nbsp;&nbsp;&nbsp;'category': STRING, <br>&nbsp;&nbsp;&nbsp;'newest_price': Object, <br>&nbsp;&nbsp;&nbsp;'prices': Array, <br>&nbsp;&nbsp;&nbsp;'transactions': Array, <br>&nbsp;&nbsp;&nbsp;'stock_analyses': Array, <br>]}<br><br>Status: 200<br>|
